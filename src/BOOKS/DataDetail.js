...
const DataDetail = ({name, match }) => {
  const { params: { productId }} = match;
  const product = Data[productId];

  const [color, setColor] = useState("red");
 
  const [image2,setImage2] = useState("/r2.jpg");
...
<button type="button" className='blue bg-gradient-info ms-5 m-1 mt-5 rounded'style={{width:'5em',height:'2.8em'}}   onClick={() => setImage2("./r2.webp")}></button>

<button type="button" className='blue bg-secondary ms-5 m-1 mt-5 rounded' style={{width:'5em',height:'2.8em'}}  onClick={() => setImage2("./r3.webp")}></button>


<button type="button" className='blue bg-pink m-1 ms-5 mt-5 rounded' style={{width:'5em',height:'2.8em'}}  onClick={() => setImage2("./r4.webp")}></button>

<button type="button" className='blue bg-dark ms-5  m-1 mt-5 rounded'style={{width:'5em',height:'2.8em'}}   onClick={() => setImage2("./r1.webp")}></button>
